...
func (m *metadataMgr) AllGoVersFromName(name string) ([]string, error) {
	queryFunc := func(name string) ([]string, error) {
		exists, err := m.ModuleExists(name)
		if !exists {
